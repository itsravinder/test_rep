namespace RRD.BT.Core.GetOrderStatus {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"RRD.BT.Core.GetOrderStatus.GetOrderStatusTableType_dbo", typeof(global::RRD.BT.Core.GetOrderStatus.GetOrderStatusTableType_dbo))]
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"RRD.BT.Core.GetOrderStatus.GetOrderStatusDataSetSchema", typeof(global::RRD.BT.Core.GetOrderStatus.GetOrderStatusDataSetSchema))]
    public sealed class GetOrderStatusProcedure_dbo : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:ns3=""http://schemas.microsoft.com/Sql/2008/05/Types/TableTypes/dbo"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:ns4=""http://schemas.datacontract.org/2004/07/System.Data"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.microsoft.com/Sql/2008/05/Procedures/dbo"" version=""1.0"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:import schemaLocation=""RRD.BT.Core.GetOrderStatus.GetOrderStatusTableType_dbo"" namespace=""http://schemas.microsoft.com/Sql/2008/05/Types/TableTypes/dbo"" />
  <xs:import schemaLocation=""RRD.BT.Core.GetOrderStatus.GetOrderStatusDataSetSchema"" namespace=""http://schemas.datacontract.org/2004/07/System.Data"" />
  <xs:annotation>
    <xs:appinfo>
  ...
  <xs:element name=""usp_bts_OrdGetOrderStatusResponse"">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        public GetOrderStatusProcedure_dbo() {
        }
