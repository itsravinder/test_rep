namespace RRD.BT.Core.GetOrderStatus.ExternalSchemas {
    ...
    [Schema(@"http://externalschemas.rrd.com/digitalpcs/v1.0",@"GetOrderStatusResponse")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"GetOrderStatusResponse"})]
    public sealed class API_GetOrderStatusResponse : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:element name=""GetOrderStatusResponse"">
    <xs:complexType>
      <xs:sequence>
        ...
        public API_GetOrderStatusResponse() {
        }
