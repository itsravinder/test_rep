namespace RRD.BT.Core.GetOrderStatus.InternalSchemas {
    ...
    [Schema(@"http://internalschemas.rrd.com/digitalpcs/v1.0",@"GetOrderStatus")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"GetOrderStatus"})]
    public sealed class Core_GetOrderStatus : Microsoft.XLANGs.BaseTypes.SchemaBase {
