namespace FF_To_Sql {
    ...
    [SchemaRoots(new string[] {@"MasterInsert", @"MasterInsertResponse"})]
      ...
      <xs:sequence>
        ...
        public override string[] RootNodes {
            get {
                ...
                _RootElements[0] = "MasterInsert";
                _RootElements[1] = "MasterInsertResponse";
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedProcedures/dbo",@"MasterInsert")]
        [System.SerializableAttribute()]
        [SchemaRoots(new string[] {@"MasterInsert"})]
        public sealed class MasterInsert : Microsoft.XLANGs.BaseTypes.SchemaBase {
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedProcedures/dbo",@"MasterInsertResponse")]
        [System.SerializableAttribute()]
        [SchemaRoots(new string[] {@"MasterInsertResponse"})]
        public sealed class MasterInsertResponse : Microsoft.XLANGs.BaseTypes.SchemaBase {
            
            [System.NonSerializedAttribute()]
            private static object _rawSchema;
            
            public MasterInsertResponse() {
            }
            ...
            public override string[] RootNodes {
                get {
                    string[] _RootElements = new string [1];
                    _RootElements[0] = "MasterInsertResponse";
                    return _RootElements;
                }
            }
