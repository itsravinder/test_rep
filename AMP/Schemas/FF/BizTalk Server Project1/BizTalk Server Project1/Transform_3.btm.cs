namespace BizTalk_Server_Project1 {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"BizTalk_Server_Project1.FfDxsd", typeof(global::BizTalk_Server_Project1.FfDxsd))]
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0"" version=""1.0"" xmlns:s0=""http://BizTalk_Server_Project1.FfDxsd"" xmlns:ns0=""http://BizTalk_Server_Project1.NormalXML"">
  ...
  <xsl:template match=""/s0:Root"">
    <ns0:Customer>
      <xsl:for-each select=""Root_Child1"">
        ...
        private const string _strSrcSchemasList0 = @"BizTalk_Server_Project1.FfDxsd";
        
        private const global::BizTalk_Server_Project1.FfDxsd _srcSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"BizTalk_Server_Project1.FfDxsd";
                return _SrcSchemas;
            }
        }
